...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleEmpleadoDuplicado(EmpleadoDuplicadoException ex) {
        return buildErrorResponse(HttpStatus.CONFLICT, "Empleado duplicado", ex.getMessage());
    }

    @ExceptionHandler(EmpleadoNoEncontradoException.class)
    public ResponseEntity<Map<String, Object>> handleEmpleadoNoEncontrado(EmpleadoNoEncontradoException ex) {
        return buildErrorResponse(HttpStatus.NOT_FOUND, "Empleado no encontrado", ex.getMessage());
    }
